...
import src.net.launcher.utils.EncodingUtils;
import src.net.launcher.utils.GuardUtils;
...
public class Game extends JFrame
{
        ...
        public Game(final String answer)
        {
                ...
                try
                {
                        ...
                        urls[0] = new File(bin, src.net.launcher.utils.ThreadUtils.l).toURI().toURL();
                        urls[1] = new File(bin, src.net.launcher.utils.ThreadUtils.e).toURI().toURL();
                        urls[2] = new File(bin, src.net.launcher.utils.ThreadUtils.f).toURI().toURL();
                        urls[3] = new File(bin, src.net.launcher.utils.ThreadUtils.m).toURI().toURL();
                ...
                else
                {
                        try
                   {
                          ...
                          params.add("-cp");
                          params.add(jarpath+ src.net.launcher.utils.ThreadUtils.l+cps+jarpath+ src.net.launcher.utils.ThreadUtils.e+cps+jarpath+ src.net.launcher.utils.ThreadUtils.f+cps+jarpath+ src.net.launcher.utils.ThreadUtils.m);
                          if (t == 1)
                          {
                             params.add("src.net.minecraft.client.main.Main");
                          }
                          else
                          {
                             params.add("src.net.minecraft.launchwrapper.Launch");
                          }
                          if(BaseUtils.getPropertyBoolean("fullscreen"))
                          {          

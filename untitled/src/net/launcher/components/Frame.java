...
import src.net.launcher.utils.ImageUtils;
import src.net.launcher.utils.ThemeUtils;
import src.net.launcher.utils.ThreadUtils;

import static src.net.launcher.utils.BaseUtils.*;
...
public class Frame extends JFrame implements ActionListener, FocusListener
{
	...
	public static Frame main;
		public Panel panel = new Panel(0);
			...
			public Button toGame = new Button("");
			...
			public Checkbox savePass = new Checkbox("");
	...
	{
		if(e.getSource() == login && login.getText().equals("Login...")) login.setText(empty);
		if(e.getSource() == password && new String(password.getPassword()).equals("itspassword")) password.setText(empty);
	}

	public void focusLost(FocusEvent e)
	{
		if(e.getSource() == login && login.getText().equals(empty)) login.setText("Login...");
